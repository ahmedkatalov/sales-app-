...
Для каждой позиции:
- name: каноничное правильное название (исправь опечатки/бренд: "кокакола"->"Кока-Кола", "малако"->"Молоко"). РАСКРЫВАЙ СОКРАЩЕНИЯ до полного слова: "стакан б"->"стакан большой", "стакан м"->"стакан маленький", "стакан ср"->"стакан средний" (б=большой, м=маленький, ср/с=средний); "мол"->"молоко", "сах"->"сахар". Догадайся по смыслу и верни полное человеческое название.
...
- ЗДРАВЫЙ СМЫСЛ: если количество не указано, а цена велика для 1 штуки дешёвого товара (спички, соль, салфетки, трубочки, пакеты, специи, сахар) — НЕ считай что купили 1 шт, а спроси количество ("Сколько <name> купили за <цена>?"). Абсурдная цена за единицу = это общая сумма за много штук/упаковок.
